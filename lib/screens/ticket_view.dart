...
import 'package:beleza/widgets/thick_container.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      width: size.width * 0.85, // reduce screen size.
      height: 167,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              //padding: const EdgeInsets.all(AppLayout.getHeight(16)),
              child: Column(
                children: [
                  Row( 
                    children: [
                 ...
                 ThickContainer(isColor: true),
                  ...
                  SizedBox(width: 3),
                  //SizedBox(width: AppLayout.getWidth(200)),
                  Row(
